...
screen about():
    ...
    use game_menu(_("À propos"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Conçu avec {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]\n\nCréé par Matthieu Deguili et Léo Six, étudiants en BUT MMI, pour le cours de Création Numérique Interactive.\n\n© The Bricked Olympic Quizz, 2024 - Tous droits réservés.")
